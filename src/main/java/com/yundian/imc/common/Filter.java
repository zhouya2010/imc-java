...
public class Filter implements Serializable {
     ...
     * @param right    右边条件
     */
    public Filter(Filter.Operator operator, Filter left, Filter right) {
        this.operator = operator;
        this.left = left;
        this.right = right;
    }
    ...
    public static Filter and(Filter left, Filter right) {
        return new Filter(Operator.and, left, right);
    }
    ...
    public static Filter or(Filter left, Filter right) {
        return new Filter(Operator.or, left, right);
    }
